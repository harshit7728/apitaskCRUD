...
# from .Serializers import CompanySerializer, DepartmentSerializer, UserSerializer
# from .models import Company, Department, CustomUser, company
...
#         company = Company.objects.get(id=response.data['id'])  # Get the newly created company
#
